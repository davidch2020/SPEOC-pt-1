...
# Title
title = html.H1(children='Alexander Hamilton Project', style={'textAlign': 'left'}, className='title')

#Layout of Project Description Page
...
#Layout of About Us Page
about_layout = html.Div(children=[
    html.H1('About Us'),
    html.Div([
        html.H2('Our Team'),
    ]),
    html.P('We have a dedicated team of professionals working towards our mission.'),
    html.Ul([
        html.Li('[Insert]'),
        html.Img(src='path/to/image.jpg', alt='Image Description'),
        html.Li('[Insert]'),
        html.Img(src='path/to/image.jpg', alt='Image Description'),
        html.Li('[Insert]'),
        html.Img(src='path/to/image.jpg', alt='Image Description'),
...
nav_bar = dbc.Nav(className='nav-bar', children=[
    ...
    dbc.NavLink(children='Project Description', href='/project', className='nav-link'),
    dbc.NavLink(children='About Us', href='/about', className='nav-link')
], style={'margin': 'auto'})
...
# Layout of the app with routing for navigation bar
...
#Callbacks for content based on URL pathname
